...
2. Write a concise PRD with goals, non-goals, user stories, features, and acceptance criteria.
3. Break a PRD into vertical-slice implementation issues.
4. Use GitHub to organize engineering work through issues, branches, commits, and pull requests.
5. Implement software incrementally with AI assistance while maintaining your own understanding.
6. Apply a red-green-refactor test-driven development cycle to at least part of the implementation.
7. Verify user-facing behavior using browser testing and Chrome DevTools.
8. Deliver a working product with documentation and reflection on AI usage.
...
2. **To-PRD**: Convert the clarified requirements into a PRD.
3. **To-issues**: Convert the PRD into vertical-slice implementation issues.
4. **Design / coding**: Use AI to support design decisions and implementation.
5. **TDD**: Use a red-green-refactor loop for selected issues.
6. **Browser testing / Chrome DevTools**: Verify behavior in the browser.
7. **Delivery**: Prepare the GitHub repository, README, demo, and reflection.
...
```text
.github/ISSUE_TEMPLATE/vertical-slice.md
```
...
2. The visible software engineering process used to create it.
